...
EXECS="client hostserver nicserver nicserver_rdma_hash nicserver_rdma_log nicserver_dram nicserver_dram_hash nicserver_dram_log nicserver_rdmacomp nicserver_client nicserver_client_hash"
build $1
